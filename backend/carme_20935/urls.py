...
admin.site.site_header = "CARME"
admin.site.site_title = "CARME Admin Portal"
admin.site.index_title = "CARME Admin"

# swagger
api_info = openapi.Info(
    title="CARME API",
    default_version="v1",
    description="API documentation for CARME App",
)
